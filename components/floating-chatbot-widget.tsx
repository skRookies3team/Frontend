...
import { MessageCircle, X, RotateCcw, Send, Plus, Sparkles } from 'lucide-react'
    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          size="icon"
          className="fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 shadow-lg transition-all hover:scale-110 hover:from-indigo-600 hover:to-purple-600 hover:shadow-xl md:bottom-8 md:right-8 md:h-16 md:w-16"
