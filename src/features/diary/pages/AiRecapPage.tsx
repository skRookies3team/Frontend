...
import { ArrowLeft, BookOpen, Calendar, Loader2, Plus, X, Star, Heart, Cloud, Moon, Music, Wand2, Sparkles } from "lucide-react"
    ...
    >
      ...
      <main className="container mx-auto max-w-6xl p-4 md:p-8">
        ...
        {loading ? (
          ...
          <div className="bg-red-50 border-2 border-red-100 rounded-[2rem] p-8 text-center text-red-500 font-bold">
            {error}
          </div>
        ) : recaps.length === 0 ? (
