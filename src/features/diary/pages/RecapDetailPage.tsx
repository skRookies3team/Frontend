...
export default function RecapDetailPage() {
    ...
    if (loading) {
        return (
            <div className="flex min-h-screen items-center justify-center bg-[#f3e8ff]">
    ...
    if (error || !recap) {
        return (
            <div className="min-h-screen bg-[#f3e8ff] p-4 flex items-center justify-center">
                <div className="max-w-md w-full bg-white rounded-[2rem] p-8 text-center shadow-xl border-4 border-white">
                    ...
                    <button
                        ...
                        className="w-full rounded-xl bg-purple-500 px-6 py-3 text-white font-bold shadow-md hover:bg-purple-600 transition-colors"
                    >
                        목록으로 돌아가기
                    </button>
                </div>
    ...
    return (
        <div className="min-h-screen pb-20 font-sans text-gray-800" style={{ backgroundColor: '#f3e8ff' }}>
            {/* Header */}
            <header className="sticky top-0 z-40 border-b-2 border-dashed border-purple-200 bg-white/90 backdrop-blur-md shadow-[0_4px_20px_rgba(200,180,255,0.1)]">
                <div className="container mx-auto flex max-w-4xl items-center justify-between px-4 py-4">
                    <button
                        onClick={() => navigate(-1)}
                        className="rounded-full p-2 hover:bg-purple-50 text-purple-400 hover:text-purple-600 transition-colors"
                    >
                        <ArrowLeft className="h-7 w-7" />
                    </button>
                    <h1 className="text-xl font-bold text-purple-500 font-['Jua'] flex items-center gap-2">
            ...
            <main className="container mx-auto max-w-5xl px-4 py-8">
                ...
                {isCarouselMode && (
                    <div className="mb-8 relative mx-auto max-w-4xl transform rotate-1 transition-transform hover:rotate-0 duration-500">
                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-40 h-8 bg-purple-200/50 backdrop-blur-sm -rotate-1 z-10"></div>
                        ...
                        <div className="overflow-hidden rounded-[2rem] border-[6px] border-white shadow-[0_10px_30px_rgba(0,0,0,0.1)] bg-white">
                            <div className="relative aspect-video overflow-hidden bg-gray-100">
                                ...
                                <div className="absolute bottom-8 left-8 text-white">
                                    ...
                                    <p className="mt-2 text-purple-100 md:text-lg font-medium">
                ...
                <div className="relative mx-auto max-w-5xl">
                    <div className="absolute -top-4 -right-4 w-20 h-20 bg-yellow-400 rounded-full opacity-10 animate-pulse"></div>
                    <div className="absolute top-20 -left-6 w-12 h-12 bg-purple-400 rounded-full opacity-10"></div>

                    <div className="rounded-[2.5rem] bg-white p-6 md:p-10 shadow-[8px_8px_0px_rgba(200,180,255,0.2)] border-2 border-purple-50 relative z-10 min-h-[600px]">
                        <div className="prose prose-purple max-w-none relative">

                            {/* 2. Collage Mode Header (Instead of Carousel) */}
                            {!isCarouselMode && (
                                <div className="mb-10 text-center border-b-2 border-dashed border-purple-100 pb-8">
                                    <Badge className="mb-3 bg-purple-100 text-purple-600 border-none px-3 py-1 hover:bg-purple-200">
                                        <Sparkles className="mr-1 h-3 w-3" /> AI 리캡
                                    </Badge>
                                    <h1 className="text-4xl md:text-5xl font-bold text-purple-600 font-['Jua'] mb-3 drop-shadow-sm">{recap.title}</h1>
                            ...
                            <div className="relative mb-12">
                                ...
                                {!isCarouselMode && images[0] && (
                                    <div className="float-right w-[40%] ml-4 mb-4 md:float-none md:absolute md:-right-64 md:-top-10 md:w-64 md:rotate-6 z-10 transition-transform hover:scale-105 duration-300">
                                        ...
                                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-6 bg-purple-200/40 -rotate-3 backdrop-blur-sm shadow-sm md:block hidden"></div>
                                    </div>
                                )}

                                {isCarouselMode && (
                                    <div className="flex items-center gap-3 mb-6 border-b-2 border-dashed border-purple-100 pb-4">
                                        <BookOpen className="w-8 h-8 text-purple-400" />
                                        <h3 className="text-3xl font-bold text-purple-600 font-['Jua'] m-0">{recap.title}</h3>
                                    </div>
                                )}
                                ...
                                <div className="mt-16 relative">
                                    ...
                                    {!isCarouselMode && images[1] && (
                                        <div className="float-left w-[40%] mr-4 mb-4 md:float-none md:absolute md:-left-64 md:-top-12 md:w-60 md:-rotate-3 z-10 transition-transform hover:scale-105 duration-300">
                                            ...
                                            <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-6 bg-yellow-200/40 rotate-2 backdrop-blur-sm shadow-sm md:block hidden"></div>
                                        </div>
                                    )}

                                    <h4 className="flex items-center gap-2 text-2xl font-bold text-purple-600 font-['Jua'] mb-8 clear-none relative z-0 pl-2">
                                    ...
                                    <div className="space-y-6">
                                        {recap.highlights.map((highlight, index) => (
                                            <div key={index} className="relative group">
                                                ...
                                                <div
                                                    className="rounded-2xl border-2 border-purple-100 bg-[#faf5ff] p-6 hover:bg-purple-50 transition-colors relative z-0"
                                                >
                                                    <h5 className="mb-2 text-lg font-bold text-purple-600 font-['Jua'] flex items-center gap-2">
                                                        <span className="w-6 h-6 rounded-full bg-purple-200 flex items-center justify-center text-sm text-purple-700">{index + 1}</span>
                                                        {highlight.title}
                                                    </h5>
                            ...
                            <div className="mt-10 rounded-2xl bg-gradient-to-r from-purple-100 to-indigo-50 p-6 text-center border border-purple-100 clear-both">
                                <p className="text-lg font-bold text-purple-600 font-['Jua'] flex items-center justify-center gap-2">
