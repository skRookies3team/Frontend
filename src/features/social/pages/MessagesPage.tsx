...
function MessagesContent() {
    ...
    return (
        <div className="flex h-screen bg-white overflow-hidden relative">
            ...
            <div
                className={`fixed top-0 left-[73px] h-full bg-white z-40 border-r border-gray-100 shadow-2xl transition-all duration-300 ease-in-out overflow-hidden ${isSearchOpen ? "w-[397px] translate-x-0 opacity-100" : "w-0 -translate-x-full opacity-0"
                    }`}
            >
                                ...
                                {messages?.map((msg) => {
                                    ...
                                    return (
                                        <div key={msg.id} className={`flex ${isMe ? "justify-end" : "justify-start"}`}>
                                            ...
                                            <div className={`max-w-[60%] rounded-[22px] px-4 py-2.5 text-sm leading-relaxed ${isMe
